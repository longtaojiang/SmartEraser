...
class StableDiffusionInpaintRegionPipeline(
    DiffusionPipeline,
    ...
    def __call__(
        ...
        **kwargs,
        ...
        >>> from diffusers import StableDiffusionInpaintRegionPipeline
        ...
        >>> pipe = StableDiffusionInpaintRegionPipeline.from_pretrained(
        ...
        # 7. Prepare mask latent variables, adjust this
